...
void f(double t, double *y, double bb, double *yPrime){

	double g = 9.8, k = 2.5,m = 3,b = bb; // constants
...
void central(double *yOld, double t, double h, int n, double b){
	...
	f(t,yOld,b,yPrime); // Get derivative
...
int main(int argc, char **argv){
	if(argc != 4){
		printf("Invalid input. Usage: %s stepsize (number of iterations) dampingConstant\n",argv[0]);
		return(0);
	}
